...
public class SaveServerInfoDialog extends Dialog {
    ...
    public SaveServerInfoDialog(@NonNull Context context, @StyleRes int themeResId, CallBack callBack) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_serverinfo_save);
